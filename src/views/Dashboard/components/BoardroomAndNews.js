                ...
                <Grid item xs={12} md={7}>
                    ...
                    <StyledCardWrapper style={{
                        ...
                        <Typography style={{
                            ...
                            Total Staked:<img src={bshares} style={{ "height": "16px" }} />7232
                        </Typography>
                        <Grid container spacing={0}>
                            ...
                            <Grid item xs={2} md={2}>
                                ...
                                <Typography style={{
                                    ...
                                    <img src={bshares} style={{ "height": "16px" }} />6.0000
                                </Typography>
                                <Typography style={{
                                    fontFamily: 'Nunito',
                                    fontWeight: 400,
                            ...
                            <Grid item xs={2} md={2}>
                                ...
                                <Typography style={{
                                    ...
                                    <img src={bomb} style={{ "height": "16px" }} />1660.4413
                                </Typography>
                                <Typography style={{
                                    fontFamily: 'Nunito',
                                    fontWeight: 400,
                            ...
                            <Grid item xs={5} md={5} align="center" style={{ marginTop: "1%" }}>
                                <Grid container spacing={0}>
                                    ...
                                    <Grid item xs={12} md={12} align="left">
                                        <div style={{ "background": "rgba(35, 40, 75, 0.75)", "border": "1px solid #FFFFFF", "backdropFilter": "blur(10px)", "borderRadius": "10px", width: "95%", marginTop: "2%" }}>
                                            <Typography style={{
                                                fontFamily: 'Nunito',
                                                fontWeight: 400,
                                                fontSize: '15px',
